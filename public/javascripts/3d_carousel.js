    ...
    return $(this).each(function () {
      ...
      function setupBlips()
      {
        ...
        if (options.counterStyle == 1 || options.counterStyle == 2) {
		  ...
		  var $blips_wrapper = $("<div></div>");
		  $blips_wrapper.addClass("blips_wrapper");
          var $list = $("<div align='center'></div>");
          ...
          for (var i = 0; i < pluginData.totalFeatureCount; i++) {
			...
			$blips_wrapper.append($list);
          }
          // add the blip list and then make sure it's visible
          $(pluginData.containerIDTag).append($blips_wrapper);
          $blips_wrapper.hide().show();
        }
      }
